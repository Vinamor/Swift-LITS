...
//        }
        ...
        cell.PartnerImage?.image = partner.photo
        cell.PartnerNameSurname?.text = String(describing: partner.name) + String(describing: " ") + String(describing: partner.surname)
        cell.PartnerBalance?.text = String(describing: partner.currentBalance)
